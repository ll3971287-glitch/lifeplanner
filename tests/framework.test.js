...
describe('导航框架', () => {
  ...
  it('router 注册 17 条路由', () => {
    ...
    for (const n of ['home', 'todos', 'projects', 'project-detail', 'calendar', 'checkins', 'checkin-detail', 'focus', 'tags', 'tag-detail', 'reviews', 'blueprints', 'relations', 'goals', 'media', 'food', 'settings']) {
